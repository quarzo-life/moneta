...
const example12 = () => {
  ...
  const d = money({ amount: 9n, currency: GRD });
...
const example20 = () => {
  ...
  const d = money({ amount: 1000n, currency: USD });
...
const example21 = () => {
  ...
  const b = money(parsedObject.amount);
  console.log(b);
};
...
const example23 = () => {
  ...
  const d = money({ amount: 100123n, currency: USD, scale: 3 });
...
const example24 = () => {
  ...
  const d3 = money({ amount: 500n, currency: USD });
  const d4 = money({ amount: 1000n, currency: USD, scale: 3 });
...
const example25 = () => {
  ...
  const d = money({ amount: 1000, currency: EUR, scale: 0 });
