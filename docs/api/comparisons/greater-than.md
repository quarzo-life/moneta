---
title: greaterThan
description: Check whether the value of a Money object is greater than another.
returns: boolean
---

# greaterThan

Check whether the value of a Money object is greater than another.
...
```ts
import { greaterThan, money, USD } from "jsr:@quarzo-life/moneta";

const first = money({ amount: 800n, currency: USD });
const second = money({ amount: 500n, currency: USD });

greaterThan(first, second); // true
greaterThan(second, first); // false
```
